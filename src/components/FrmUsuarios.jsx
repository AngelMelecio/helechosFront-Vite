...
const FrmUsuarios = ({
  ...
  const { saveUser, getUsuarios, updateUser, updatePassword } = useAdmin()
        ...
        <div className='w-full flex h-full flex-col '>
          <div className="z-10 py-2 px-4 flex w-full shadow-md ">
            <div className="flex flex-row w-full total-center relative h-10">
              ...
              <input
                disabled={saving}
                className='bg-teal-500 p-1 w-40 text-white font-bold normal-button absolute right-0 rounded-lg'
                type="submit"
